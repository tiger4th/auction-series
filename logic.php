...
$api_url = 'http://auctions.yahooapis.jp/AuctionWebService/V2/categoryTree?appid='.$appid.'&category='.$c;
...
if ($q != '') {
	$url = 'http://auctions.yahooapis.jp/AuctionWebService/V2/search?appid='.$appid.'&query='.$q.'&sort='.$s.'&order='.$o.'&thumbnail='.$t.'&page='.$n.'&category='.$c;
} else {
	$url = 'http://auctions.yahooapis.jp/AuctionWebService/V2/categoryLeaf?appid='.$appid.'&sort='.$s.'&order='.$o.'&thumbnail='.$t.'&page='.$n.'&category='.$c;
}
